...
public class TodoListAdapter extends RecyclerView.Adapter<TodoListAdapter.ViewHolder>{
    ...
    private List<TodoListItem> itemsChecked=Collections.emptyList();

    public class ViewHolder extends RecyclerView.ViewHolder{
        private final TextView textView;
        private TodoListItem todoItem;

        private final CheckBox toCheck;

        public ViewHolder(@NonNull View itemView){
            super(itemView);
            this.textView =itemView.findViewById(R.id.todo_item_text);
            this.toCheck=itemView.findViewById(R.id.completed);
        }
        ...
        public void setTodoItem(TodoListItem todoItem){
            ...
            this.toCheck.setChecked(todoItem.completed);
        }
    }
